...
import { STORY_BLOCKS, type StoryBlock } from "@/components/shop/story-blocks-data";
import { StoryBlocksMobileAccordion } from "@/components/shop/StoryBlocksMobileAccordion";
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 pb-10 sm:px-6 lg:px-8">
      ...
      <div className="lg:hidden">
        <StoryBlocksMobileAccordion blocks={STORY_BLOCKS} />
      </div>
